...
| `networks` | `No` | `String[]` | all networks | Restrict the bundled networks to this allow-list to reduce your final bundle size. See [Reducing bundle size](/usage/reducing-bundle-size). |
