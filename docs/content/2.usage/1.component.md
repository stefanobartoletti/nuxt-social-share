...
::warning
These AI integrations rely on unofficial, undocumented URL parameters exposed by each provider's web app. They could stop prefilling the prompt without notice if a provider changes their frontend.
::
